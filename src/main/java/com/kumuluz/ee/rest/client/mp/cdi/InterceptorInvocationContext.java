...
/**
 * Implementation of {@link InvocationContext} for RestClient interceptors.
 *
 * @author Urban Malc
 * @since 1.2.2
 */
public class InterceptorInvocationContext implements InvocationContext {
    ...
    public InterceptorInvocationContext(final Object target, final Method method, final Object[] args, final List<InterceptorInvocation> chain) {
        this.target = target;
        this.method = method;
        this.args = args;
